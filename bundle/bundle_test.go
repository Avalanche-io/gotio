...
func createTestTimeline() *gotio.Timeline {
	timeline := gotio.NewTimeline("test_timeline", nil, nil)
	...
	ref := gotio.NewExternalReference("", "file:///nonexistent/test.mov", &sr, nil)
	clip := gotio.NewClip("test_clip", ref, &sr, nil, nil, nil, "", nil)
...
func TestPrepareForBundleAllMissing(t *testing.T) {
	...
	_, ok := clips[0].MediaReference().(*gotio.MissingReference)
	if !ok {
...
func TestPrepareForBundleMissingIfNotFile(t *testing.T) {
	...
	missing, ok := clips[0].MediaReference().(*gotio.MissingReference)
	if !ok {
		t.Errorf("expected MissingReference, got %T", clips[0].MediaReference())
	}
...
func TestRelinkToBundle(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", "/path/to/test.mov", &ar, nil)
...
func TestOTIODRoundTrip(t *testing.T) {
	...
	timeline := gotio.NewTimeline("roundtrip_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	...
	clip := gotio.NewClip("test_clip", nil, &sr, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestOTIOZRoundTrip(t *testing.T) {
	...
	timeline := gotio.NewTimeline("zip_roundtrip_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
...
func TestOTIOZWithExtraction(t *testing.T) {
	...
	// Create timeline
	timeline := gotio.NewTimeline("extract_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	sr := opentime.NewTimeRange(
		opentime.NewRationalTime(0, 24),
		opentime.NewRationalTime(48, 24),
...
func TestDryRun(t *testing.T) {
	timeline := gotio.NewTimeline("dryrun_test", nil, nil)
...
func TestPrepareForBundleWithRealFile(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", mediaPath, &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
	...
	_, ok := clips[0].MediaReference().(*gotio.ExternalReference)
	if !ok {
...
func TestOTIOZWithRealMedia(t *testing.T) {
	...
	// Create timeline with real file reference
	timeline := gotio.NewTimeline("media_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	ref := gotio.NewExternalReference("", mediaPath, &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
...
func TestConvertToAbsolutePaths(t *testing.T) {
	...
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	ref := gotio.NewExternalReference("", "media/test.mov", &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
	...
	extRef := clips[0].MediaReference().(*gotio.ExternalReference)
...
func TestReadOTIODNotATimeline(t *testing.T) {
	...
	data, _ := gotio.ToJSONBytes(track)
...
func TestPrepareForBundleEmptyTargetURL(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", "", &sr, nil)
	clip := gotio.NewClip("clip", ref, &sr, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestPrepareForBundleMediaIsDirectory(t *testing.T) {
	...
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	ref := gotio.NewExternalReference("", mediaDir, &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestConvertToAbsolutePathsNonMediaPath(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", "/absolute/path/file.mov", &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestConvertToAbsolutePathsEmptyURL(t *testing.T) {
	...
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	ref := gotio.NewExternalReference("", "", &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestWriteOTIODBasenameCollision(t *testing.T) {
	...
	ref1 := gotio.NewExternalReference("", filepath.Join(tmpDir, "dir1", "same.mov"), &ar, nil)
	clip1 := gotio.NewClip("clip1", ref1, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip1)

	ref2 := gotio.NewExternalReference("", filepath.Join(tmpDir, "dir2", "same.mov"), &ar, nil)
	clip2 := gotio.NewClip("clip2", ref2, &ar, nil, nil, nil, "", nil)
...
func TestPrepareForBundleWithURLParseError(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", "http://example.com/file.mov", &sr, nil)
	clip := gotio.NewClip("clip", ref, &sr, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestWriteOTIODWithRealMediaMultiple(t *testing.T) {
	...
	timeline := gotio.NewTimeline("multi_media_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))

	ref1 := gotio.NewExternalReference("", media1, &ar, nil)
	clip1 := gotio.NewClip("clip1", ref1, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip1)

	ref2 := gotio.NewExternalReference("", media2, &ar, nil)
	clip2 := gotio.NewClip("clip2", ref2, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip2)
...
func TestGetTargetURLWithNonExternalRef(t *testing.T) {
	...
	sr := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	missingRef := gotio.NewMissingReference("test", &sr, nil)

	// Call getTargetURL indirectly through PrepareForBundle
	timeline := gotio.NewTimeline("test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	clip := gotio.NewClip("clip", missingRef, &sr, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
...
func TestWriteOTIODMultipleMediaFiles(t *testing.T) {
	...
	timeline := gotio.NewTimeline("multi_test", nil, nil)
	track := gotio.NewTrack("V1", nil, gotio.TrackKindVideo, nil, nil)
	ar := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))

	for i, media := range []string{media1, media2, media3} {
		ref := gotio.NewExternalReference("", media, &ar, nil)
		clip := gotio.NewClip(filepath.Base(media), ref, &ar, nil, nil, nil, "", nil)
...
func TestWriteOTIODErrorIfNotFilePolicyWithMissingFile(t *testing.T) {
	...
	ref := gotio.NewExternalReference("", "/nonexistent/file.mov", &ar, nil)
	clip := gotio.NewClip("clip", ref, &ar, nil, nil, nil, "", nil)
	track.AppendChild(clip)
	timeline.Tracks().AppendChild(track)
