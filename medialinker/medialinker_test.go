...
func createTestClip(name string, url string) *gotio.Clip {
	...
	if url != "" {
		ref = gotio.NewExternalReference("", url, &sr, nil)
	}
	return gotio.NewClip(name, ref, &sr, nil, nil, nil, "", nil)
}

func createTestTimeline(clips ...*gotio.Clip) *gotio.Timeline {
...
func TestLinkMediaWithLinker(t *testing.T) {
	...
	missing := gotio.NewMissingReference("", nil, nil)
	...
	missingRef, ok := ref.(*gotio.MissingReference)
	if !ok {
...
func TestLinkClip(t *testing.T) {
	...
	clip.SetMediaReference(gotio.NewMissingReference("", nil, nil))
	...
	meta := clip.MediaReference().(*gotio.MissingReference).Metadata()
...
func TestDirectoryLinker(t *testing.T) {
	...
	extRef := ref.(*gotio.ExternalReference)
	if extRef.TargetURL() != testFile {
		t.Errorf("expected %s, got %s", testFile, extRef.TargetURL())
	}
}
...
func TestLinkMediaContinueOnError(t *testing.T) {
	...
	clip1.SetMediaReference(gotio.NewMissingReference("", nil, nil))
	clip2.SetMediaReference(gotio.NewMissingReference("", nil, nil))
	clip3.SetMediaReference(gotio.NewMissingReference("", nil, nil))
	...
	for _, clip := range clips {
		ref := clip.MediaReference()
		if missing, ok := ref.(*gotio.MissingReference); ok {
...
func TestLinkMedia(t *testing.T) {
	...
	missing := ref.(*gotio.MissingReference)
...
func TestPathTemplateLinkerWithMissingReference(t *testing.T) {
	...
	missingRef := gotio.NewMissingReference("", &sr, meta)
	clip := gotio.NewClip("test_clip", missingRef, &sr, nil, nil, nil, "", nil)
...
func TestDirectoryLinkerNoName(t *testing.T) {
	...
	sr := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	clip := gotio.NewClip("", nil, &sr, nil, nil, nil, "", nil)
...
func TestDirectoryLinkerFromExternalRef(t *testing.T) {
	...
	sr := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	extRef := gotio.NewExternalReference("", "/other/path/original_name.mov", &sr, nil)
	clip := gotio.NewClip("", extRef, &sr, nil, nil, nil, "", nil)
...
func TestMetadataLinkerNonMissing(t *testing.T) {
	...
	sr := opentime.NewTimeRange(opentime.NewRationalTime(0, 24), opentime.NewRationalTime(48, 24))
	extRef := gotio.NewExternalReference("", "/path/file.mov", &sr, nil)
	clip := gotio.NewClip("test", extRef, &sr, nil, nil, nil, "", nil)
...
func TestMetadataLinkerDefaultMissingReference(t *testing.T) {
	...
	missing, ok := ref.(*gotio.MissingReference)
	if !ok {
		t.Fatalf("expected MissingReference, got %T", ref)
	}
